...
interface SavedPdfPageCardProps {
  item: BasketItem;
  onRemove: () => void;
  onViewPage: () => void;
}

export const SavedPdfPageCard: React.FC<SavedPdfPageCardProps> = ({
  item,
  onRemove,
  onViewPage,
}) => {
  ...
  return (
    ...
    >
      <Image
        source={{ uri: pdfPage.pageImageUri }}
        style={styles.image}
        resizeMode="cover"
      />
      ...
      <View style={styles.content}>
        ...
        <View style={styles.infoRow}>
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>صفحة {pdfPage.pageNumber}</Text>
          </View>
        </View>
        ...
        <View style={styles.savedContainer}>
          ...
          <Text style={styles.savedText}>
            تم الحفظ {formatDate(pdfPage.savedAt, 'ar')}
          </Text>
        </View>
      </View>
    </TouchableOpacity>
...
export default SavedPdfPageCard;
